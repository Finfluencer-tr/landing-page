                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <div className="glass-card p-6 rounded-2xl border border-white/5 bg-slate-900/40">
                                <span className="text-sm text-slate-500 font-medium uppercase tracking-wider">{t.influencer.total_analyzed || "Analyzed"}</span>
                                <div className="text-3xl font-bold text-white mt-1">{influencer.stats.total_analyzed}</div>
                            </div>
                            <div className="glass-card p-6 rounded-2xl border border-white/5 bg-slate-900/40">
                                <span className="text-sm text-slate-500 font-medium uppercase tracking-wider">{t.influencer.financial_count || "Financial"}</span>
                                <div className="text-3xl font-bold text-white mt-1">{influencer.stats.financial_count}</div>
                            </div>
                            <div className="glass-card p-6 rounded-2xl border border-white/5 bg-slate-900/40">
                                <span className="text-sm text-slate-500 font-medium uppercase tracking-wider">{t.influencer.avg_performance || "Avg Perf"}</span>
                                <div className="text-3xl font-bold text-indigo-400 mt-1">{influencer.stats.avg_performance}%</div>
                            </div>
                        </div>
